...
export class LeadController {
  ...
  @ApiBadRequestResponse({ description: 'Invalid input data' })
  @ApiNotFoundResponse({ description: 'Lead form not found' })
  async updateLeadForm(@Param('id') id: string, @Body() dto: UpdateLeadFormDto, @Request() req) {
    const businessId = req.user.businessId;
  ...
  @ApiBadRequestResponse({ description: 'Invalid input data' })
  @ApiNotFoundResponse({ description: 'Lead not found' })
  async updateLead(@Param('leadId') leadId: string, @Body() dto: UpdateLeadDto, @Request() req) {
    const businessId = req.user.businessId;
