...
export class StoreFrontController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves public information about a store/business. This endpoint returns only non-sensitive data suitable for public display.',
  })
  @ApiParam({
    name: 'businessId',
    type: Number,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a paginated list of in-stock products for a specific store with filtering options. Only returns products that are currently in stock.',
  })
  @ApiParam({
    name: 'businessId',
    type: Number,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves detailed information about a specific product including business information. Only returns public, non-sensitive data.',
  })
  @ApiParam({
    name: 'businessId',
    type: Number,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all product categories that have in-stock products in this store, including the count of products in each category.',
  })
  @ApiParam({
    name: 'businessId',
    type: Number,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all in-stock products in a specific category for a store with pagination and additional filtering options.',
  })
  @ApiParam({
    name: 'businessId',
    type: Number,
  ...
  async getProductsByCategory(
    ...
    return this.storeFrontService.getProductsByCategory(businessId, categoryId, query);
  }
}
