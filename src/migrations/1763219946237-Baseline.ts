...
`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "leads" DROP CONSTRAINT IF EXISTS "FK_987cb4ff04d8e38b9b6f3bb105a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews" DROP CONSTRAINT IF EXISTS "FK_1e6c554d615dd5a5bf0e11ee0ef"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews" DROP CONSTRAINT IF EXISTS "FK_53a68dc905777554b7f702791fd"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews" DROP CONSTRAINT IF EXISTS "FK_a6b3c434392f5d10ec17104366b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews" DROP CONSTRAINT IF EXISTS "FK_d17ce9c119d29c7ec8c884044c7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews" DROP CONSTRAINT IF EXISTS "FK_7ed5659e7139fc8bc039198cc1e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "order_items" DROP CONSTRAINT IF EXISTS "FK_cdb99c05982d5191ac8465ac01f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "order_items" DROP CONSTRAINT IF EXISTS "FK_f1d359a55923bb45b057fbdab0d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP CONSTRAINT IF EXISTS "FK_778777c5d7d56ed1bbaa907b8e5"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "products" DROP CONSTRAINT IF EXISTS "FK_359bd8406fbfb50e3ea42b5631f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "products" DROP CONSTRAINT IF EXISTS "FK_99d90c2a483d79f3b627fb1d5e9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "categories" DROP CONSTRAINT IF EXISTS "FK_9a6f051e66982b5f0318981bcaa"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_sizes" DROP CONSTRAINT IF EXISTS "FK_699f5366c2ebf46a77589bd225e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "otps" DROP CONSTRAINT IF EXISTS "FK_82b0deb105275568cdcef2823eb"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT IF EXISTS "FK_78725ac7117e7526e028014606"`,
    );
    await queryRunner.query(
      `ALTER TABLE "businesses" DROP CONSTRAINT IF EXISTS "FK_5ba6375fdc72387a2d2d0bb7720"`,
    );
    await queryRunner.query(
      `ALTER TABLE "businesses" DROP CONSTRAINT IF EXISTS "FK_01845bacd013698b8bffb920933"`,
    );
    await queryRunner.query(
