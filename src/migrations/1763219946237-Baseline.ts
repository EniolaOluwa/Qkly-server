...
`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "leads" DROP CONSTRAINT IF EXISTS "FK_987cb4ff04d8e38b9b6f3bb105a"`);
        await queryRunner.query(`ALTER TABLE "reviews" DROP CONSTRAINT IF EXISTS "FK_1e6c554d615dd5a5bf0e11ee0ef"`);
        await queryRunner.query(`ALTER TABLE "reviews" DROP CONSTRAINT IF EXISTS "FK_53a68dc905777554b7f702791fd"`);
        await queryRunner.query(`ALTER TABLE "reviews" DROP CONSTRAINT IF EXISTS "FK_a6b3c434392f5d10ec17104366b"`);
        await queryRunner.query(`ALTER TABLE "reviews" DROP CONSTRAINT IF EXISTS "FK_d17ce9c119d29c7ec8c884044c7"`);
        await queryRunner.query(`ALTER TABLE "reviews" DROP CONSTRAINT IF EXISTS "FK_7ed5659e7139fc8bc039198cc1e"`);
        await queryRunner.query(`ALTER TABLE "order_items" DROP CONSTRAINT IF EXISTS "FK_cdb99c05982d5191ac8465ac01f"`);
