...
export class Baseline1763052149639 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "product_sizes" ("id" SERIAL NOT NULL, "measurement" "public"."product_sizes_measurement_enum" NOT NULL, "value" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "productId" integer, CONSTRAINT "PK_19c3d021f81c5b1ff367bad6164" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "categories" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "parentId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_8b0be371d28245da6e4f4b61878" UNIQUE ("name"), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_f421c8981cca05954f98667134" ON "order_items" ("status") `,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" DROP CONSTRAINT "UQ_b44079e7599f6198a41c9dde63f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "transactionRef"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "transactionStatus"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."orders_transactionstatus_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "transactionMedium"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."orders_transactionmedium_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "dateOfTransaction"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "productDetails"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "walletReference" character varying`,
    );
    await queryRunner.query(
      `COMMENT ON COLUMN "users"."walletReference" IS 'Monnify wallet reference'`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "walletAccountName" character varying`,
    );
    await queryRunner.query(
      `COMMENT ON COLUMN "users"."walletAccountName" IS 'Monnify wallet account name'`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "walletBankName" character varying`,
    );
    await queryRunner.query(
      `COMMENT ON COLUMN "users"."walletBankName" IS 'Monnify wallet bank name'`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "walletBankCode" character varying`,
    );
    await queryRunner.query(
      `COMMENT ON COLUMN "users"."walletBankCode" IS 'Monnify wallet bank code'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "products" ADD "quantityInStock" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "products" ADD "hasVariation" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `COMMENT ON COLUMN "products"."hasVariation" IS 'Does this product include size or color variations?'`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "orderReference" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "UQ_a8bdfcfdf8520db858774ab453c" UNIQUE ("orderReference")`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "transactionReference" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "UQ_3b5b32cf9f908e4cf776a94d2a9" UNIQUE ("transactionReference")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "deliveryMethod" "public"."orders_deliverymethod_enum" NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "subtotal" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "shippingFee" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "tax" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "discount" numeric(10,2) NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "total" numeric(10,2) NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "estimatedDeliveryDate" TIMESTAMP`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "isBusinessSettled" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "settlementReference" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "settlementDate" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "settlementDetails" json`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "reviews" ADD "orderItemId" integer NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "reviews" ADD "imageUrls" text`);
    await queryRunner.query(
      `COMMENT ON COLUMN "reviews"."imageUrls" IS 'Array of image URLs'`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews" ADD "isVisible" boolean NOT NULL DEFAULT true`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews" ADD "isVerifiedPurchase" boolean NOT NULL DEFAULT false`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "phone" character varying(20) NOT NULL DEFAULT ''`,
    );
    await queryRunner.query(
      `UPDATE "users" SET "phone" = 'TEMP_PHONE_' || id::text WHERE "phone" = ''`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_359bd8406fbfb50e3ea42b5631" ON "products" ("businessId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_0591b4a1abb428c6d86744cc0a" ON "products" ("quantityInStock") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_63fcb3d8806a6efd53dbc67430" ON "products" ("createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_69e49df9a08f8ded911758822f" ON "products" ("userId", "businessId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_151b79a83ba240b0cb31b2302d" ON "orders" ("userId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_778777c5d7d56ed1bbaa907b8e" ON "orders" ("businessId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_775c9f06fc27ae3ff8fb26f2c4" ON "orders" ("status") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_01b20118a3f640214e7a8a6b29" ON "orders" ("paymentStatus") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1f4b9818a08b822a31493fdee9" ON "orders" ("createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5025e0259ec0b1ffb5f0ea6685" ON "orders" ("userId", "businessId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_1e6c554d615dd5a5bf0e11ee0e" ON "reviews" ("orderItemId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "product_sizes" ADD CONSTRAINT "FK_699f5366c2ebf46a77589bd225e" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "products" ADD CONSTRAINT "FK_ff56834e735fa78a15d0cf2192" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reviews" ADD CONSTRAINT "FK_1e6c554d615dd5a5bf0e11ee0e9" FOREIGN KEY ("orderItemId") REFERENCES "order_items"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "reviews" DROP CONSTRAINT "FK_1e6c554d615dd5a5bf0e11ee0e9"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_sizes" DROP CONSTRAINT "FK_699f5366c2ebf46a77589bd225e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1e6c554d615dd5a5bf0e11ee0e"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5025e0259ec0b1ffb5f0ea6685"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_01b20118a3f640214e7a8a6b29"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_778777c5d7d56ed1bbaa907b8e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_151b79a83ba240b0cb31b2302d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_69e49df9a08f8ded911758822f"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_63fcb3d8806a6efd53dbc67430"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0591b4a1abb428c6d86744cc0a"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_359bd8406fbfb50e3ea42b5631"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `COMMENT ON COLUMN "users"."walletAccountNumber" IS 'Virtual account number'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "settlementDetails"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "settlementDate"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "settlementReference"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "isBusinessSettled"`,
    );
    await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "notes"`);
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "deliveryDetails"`,
    );
    await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "deliveryDate"`);
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "estimatedDeliveryDate"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" DROP CONSTRAINT "UQ_3b5b32cf9f908e4cf776a94d2a9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "transactionReference"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP CONSTRAINT "UQ_a8bdfcfdf8520db858774ab453c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "orderReference"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "products" DROP COLUMN "hasVariation"`,
    );
    await queryRunner.query(
      `ALTER TABLE "products" DROP COLUMN "quantityInStock"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "productDetails" json NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "dateOfTransaction" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."orders_transactionmedium_enum" AS ENUM('web', 'mobile')`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "transactionMedium" "public"."orders_transactionmedium_enum" NOT NULL`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."orders_transactionstatus_enum" AS ENUM('pending', 'successful', 'failed', 'cancelled')`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "transactionStatus" "public"."orders_transactionstatus_enum" NOT NULL DEFAULT 'pending'`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."orders_orderstatus_enum" AS ENUM('ordered', 'dispatched', 'delivered', 'returned')`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "orderStatus" "public"."orders_orderstatus_enum" NOT NULL DEFAULT 'ordered'`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "transactionRef" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "UQ_b44079e7599f6198a41c9dde63f" UNIQUE ("transactionRef")`,
    );
    await queryRunner.query(
      `ALTER TABLE "products" ADD "title" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "products" ADD "color" character varying`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f421c8981cca05954f98667134"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."product_sizes_measurement_enum"`,
    );
  }
}
