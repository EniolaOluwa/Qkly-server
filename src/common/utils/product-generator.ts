import {
  ...
  MeasurementType,
  SizeDto,
} from '../../core/product/dto/create-product.dto';
...
export const generateRandomProduct = (options: RandomProductOptions): CreateProductDto => {
  ...
  const productNameMap: Record<string, string[]> = {
    "Men's Fashion": ['Classic Linen Shirt', 'Slim Fit Jeans', 'Leather Jacket', 'Casual Polo Tee'],
    "Women's Fashion": ['Silk Summer Dress', 'Chiffon Blouse', 'High-Waist Skirt', 'Denim Jacket'],
    'Beauty & Personal Care': [
  ...
  const sizes: SizeDto[] | undefined = hasVariation
    ...
    : undefined;
  const colors = hasVariation ? [generateHexColor(), generateHexColor()] : undefined;
